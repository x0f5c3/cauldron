...
impl<'r, 'a, R: ReadBuffer> Crc8Reader<'r, 'a, R> {
    /// Creates new CRC 8 reader with initial value 0
    pub fn new(crc16reader: &'a mut Crc16Reader<'r, R>) -> Crc8Reader<'r, 'a, R> {
        Crc8Reader {
            state: 0,
            crc16reader,
        }
